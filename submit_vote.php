...
if(mysqli_num_rows($sql) > 0 ) {
	$msg="<center><h4><font color='#FF0000'>You can only vote once. Thank you!</h4></center></font>";
		include 'voter.php';
		exit();	
}
else{
...
$sql3 = mysqli_query($con, 'UPDATE voters SET voted= "'.$_POST['lan'].'" WHERE username="'.$_SESSION['SESS_NAME'].'"');
	...
	$msg="<center><h4><font color='#FF0000'>Congratulations, your vote has been submitted.</h4></center></font>";
	include 'voter.php';
	exit();
	}
}
